...
export interface Analysis { settings: Settings; trackIndex: number; peaks: number[]; cuts: Cut[]; candidates: { start: number; end: number }[] }
export interface Output { id: string; name: string; duration: number; size: number; verified: boolean }
