...
긴 영상 매트릭스 12회 중 브라우저 60분 3회·두 앱 10분 6회, 총 9회를 완료했다. Mac 60분 3회는 현재 실행 중이다. 사전 검사인 60초 4회는 이 12회에 합산하지 않는다. 실제 한국어 발화/CER·시간 절감·인증 AI·파일 캐시 없는 앱 실행·Mac OS 네트워크 차단은 별도 미검증 항목이다.
