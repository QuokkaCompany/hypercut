...
10분/60분 × 두 앱 × cold/warm × 각 3회는 아직 수행하지 않았다. 고정한 러너로 브라우저 60분 cold부터 순차 실행하고 완결된 실패가 나오면 원인을 해결하기 전에 나머지 조건으로 확대하지 않는다. 실제 한국어 품질·작업 시간·인증 AI·Mac OS 네트워크 차단 및 OS 전체 cold-cache는 별도 미검증이다.
