...
- [기본 무음 모드의 입력 캐시 검사](2026-09-06-threshold-input-cache-results.md): 현재 후보에서 60초 기본/cold/warm × 두 앱 × 2회, 총 12회와 취소·재시도 6조건 통과. 프로젝트 저장·취소의 RSS 원본을 추가했고 감사 대조 8조건도 통과했다. 기본 모드의 이전 60분 메모리 실패는 새 장시간 결과가 나오기 전까지 미해결로 유지한다.
