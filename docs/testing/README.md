...
- [입력 파일 캐시 관측과 실제 앱 검사](2026-09-06-input-cache-results.md): 네이티브 연결 도구 9 PASS, 기본 경로 60초 회귀 4회와 cold/warm 두 앱 8회 완료. 후속 브라우저 60분 cold 3회도 매번 0/4,350페이지를 확인하고 출력·프로젝트·취소·재시도를 통과했다. 최대 RSS는 1.590GiB였다. 정식 24회 중 나머지 21회와 OS 전체 cold-cache는 아직 미검증이다. [측정 계획](../plans/2026-09-06-cache-verification-plan.md).
