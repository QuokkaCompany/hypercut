...
- [인코더 동시 처리 2개 후보](2026-09-06-encoder-two-results.md): 같은 화질 설정의 60초 백엔드 비교에서 최대 RSS가 약 39.42MiB 감소하고 출력은 약 0.47초 늘었다. 전체 디코딩 프레임·오디오가 같았고 단위 80개·통합 38개·패키징·두 앱 60초 합성 4회가 완료됐다. 브라우저 60분 3회는 RSS 1.752 / 1.890 / 1.956GiB로 통과했고 이전 후보와 전체 85,997프레임·PTS·오디오도 같았다. 두 앱 10분 6회도 모두 통과했으며 최대 RSS는 Chrome 1.728GiB·Mac 1.164GiB였다. 전체 출력 정답·프로젝트·조작·취소 후 재시도를 확인했다. 장시간 12회 중 9회 완료이며 Mac 60분 3회는 실행 중이다.
- [캐시 검증 준비](../plans/2026-09-06-cache-verification-plan.md): 파일 복사·상주 관측 도구를 추가했다. 비정렬 길이의 마지막 페이지가 남는 첫 방식을 수정해 5개 크기에서 읽기 전 상주 0개·읽기 뒤 전체 상주와 바이트 보존을 확인했다. 실제 앱의 파일 캐시 없는 실행과 OS 전체 cold-cache는 미검증이다.
