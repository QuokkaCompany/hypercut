...
- [긴 영상 동시 합성 계획](../plans/2026-09-06-long-composition-plan.md): 10분/60분 컷·자막·효과음의 실제 출력·취소·저장·메모리·조작 검증. 독립 검증기·60초 엔진 사전 검사는 완료했고 장시간 동시 합성은 실행 전이다.
...
| [컷 경계·동시 합성 검증기](2026-09-06-composition-oracle-results.md) | 전체 프레임 검사로 경계 프레임 누출 발견·정수 PTS 수정. 독립 회귀 3건·60초 엔진 합성·두 앱 threshold 사전 검사 통과. 장시간 동시 합성 미실행 |
