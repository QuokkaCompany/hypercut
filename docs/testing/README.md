...
- [긴 영상 동시 합성 계획](../plans/2026-09-06-long-composition-plan.md): 10분/60분 컷·자막·효과음의 실제 출력·취소·저장·메모리·조작 검증. 독립 검증기와 두 앱 60초 동시 합성·취소·재시도 완료. 첫 60분의 메모리·자막 응답 실패 뒤 후보의 첫 재측정은 RSS 1.968GiB로 통과, 자막 p95 225ms로 실패했다. 자막 행 렌더링 후보의 두 앱 기능·60초 합성 4회를 완료했으며 장시간 재측정은 남아 있다.
