...
- [긴 영상 동시 합성 계획](../plans/2026-09-06-long-composition-plan.md): 10분/60분 컷·자막·효과음의 실제 출력·취소·저장·메모리·조작 검증. 실행 전 계획이다.
...
| [자동화 탐색 비용 비교](2026-09-06-selector-overhead-results.md) | 같은 앱의 CSS 조건 9회 통과·최대 1.980GiB. 출력 동일성 감사 완료, Mac 60분 3회 진행 중. 기존 역할 기반 실패 보존 |
