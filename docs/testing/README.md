...
- [입력 파일 캐시 관측과 실제 앱 사전 검사](2026-09-06-input-cache-results.md): 네이티브 연결 도구 9 PASS, 기본 경로 60초 회귀 4회와 cold/warm 두 앱 8회 완료. 선택 직전 매번 0/74 또는 74/74 상주를 확인했고 전체 출력·프로젝트·취소·재시도를 보존했다. 10분/60분 조건별 반복과 OS 전체 cold-cache는 아직 미검증이다. [측정 계획](../plans/2026-09-06-cache-verification-plan.md).
