...
작성일: 2026-09-06. 상태: 독립 검증기 보정과 60초 엔진 사전 검사 완료. 두 앱 동시 합성 및 장시간 반복은 실행 전. [전사·자막·효과음 계획](2026-09-05-caption-effects-validation-plan.md)의 C05/C09/C10·FX05와 기존 긴 영상 성능 기준을 함께 확인한다. 짧은 합성·개별 기능 통과를 긴 영상 동시 합성의 증거로 대체하지 않는다.
