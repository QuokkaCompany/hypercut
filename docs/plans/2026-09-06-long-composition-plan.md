...
작성일: 2026-09-06. 상태: 독립 검증기 보정과 60초 엔진 사전 검사 완료. 두 앱의 60초 동시 합성·취소·재시도는 완료. 첫 브라우저 60분의 정확성은 통과했지만 메모리·자막 응답은 실패. 개선 후보 첫 재측정은 RSS 1.968GiB 통과·자막 p95 225ms 실패. 행 렌더링 후보의 두 앱 기능·60초 합성 4회 통과. 후보의 브라우저 60분 첫 실행 통과, 같은 앱의 두 번째 실행 중. [전사·자막·효과음 계획](2026-09-05-caption-effects-validation-plan.md)의 C05/C09/C10·FX05와 기존 긴 영상 성능 기준을 함께 확인한다. 짧은 합성·개별 기능 통과를 긴 영상 동시 합성의 증거로 대체하지 않는다.
