...
4. 구간을 선택해 들어보고 필요한 컷은 복원합니다. 실행 취소·다시 실행을 지원합니다.
...
실제 통과 결과와 미실행 범위는 [2026-09-05 프리뷰 검증 결과](docs/testing/2026-09-05-preview-results.md)에 기록했습니다. 현재 정식 MVP 전체 검증이 완료된 상태는 아닙니다.
