...
실제 통과 결과와 미실행 범위는 [첫 프리뷰 검증 결과](docs/testing/2026-09-05-preview-results.md)와 [복구·부분 복원·앱 성능 후속 결과](docs/testing/2026-09-05-recovery-results.md)에 기록했습니다. 현재 정식 MVP 전체 검증이 완료된 상태는 아닙니다.
