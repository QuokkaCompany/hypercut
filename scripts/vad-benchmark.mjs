...
for (const file of ['src/App.tsx','server/media.mjs','server/vad.mjs','scripts/vad-benchmark.mjs','scripts/helpers/performance.mjs','assets/models/silero_vad.onnx','package-lock.json','release/HyperCut-darwin-arm64/HyperCut.app/Contents/Resources/app.asar']) report.sourceHashes[file] = await sha256(file);
