...
const result = { status: 'PASS', externalConnectionProbe: denial, profile, scope: 'OS non-loopback network denial applied to actual browser, local server, bundled VAD and Whisper inference, caption editing and SRT export. Generated Korean TTS only.', desktopOSIsolation: 'NOT_RUN: nested Electron sandbox limitation recorded in recovery report; native app security remains enabled.' };
